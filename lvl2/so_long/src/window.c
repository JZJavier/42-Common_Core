...
/*   Updated: 2024/02/19 00:51:53 by jjuarez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	map->img_player = mlx_xpm_file_to_image(map->mlx_ptr, PLAYER,
	...
	if (map->img_wall == NULL)
		ft_error("Error: Wall.xpm couldn't be opened!", map);
}
